...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "QCustomPlot Scrollbar Axis Range Control Demo", Q_NULLPTR));
        actionInsert_Plot->setText(QApplication::translate("MainWindow", "Insert Plot", Q_NULLPTR));
        actionSave_Document->setText(QApplication::translate("MainWindow", "Save Document...", Q_NULLPTR));
    } // retranslateUi
