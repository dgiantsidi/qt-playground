...
void MainWindow::setupPlot()
{
    ...
    ui->plot->axisRect()->setMinimumMargins(QMargins(left, top, right, bottom)); // add some more minimum space at bottom left of rect for subfigure label (15 is default)
...
void MainWindow::horzScrollBarChanged(int value)
{
    ...
    if (qAbs(ui->plot->xAxis->range().center() > value)) // if user is dragging plot, we don't want to replot twice
    {
        std::cout << "setRange() " << value << "  " << ui->plot->xAxis->range().size() << "\n";
