...
void MainWindow::setupDemo(int demoIndex)
{
    switch (demoIndex)
    {
        ...
        case 0:  setupSimpleDemo(ui->customPlot); break;
...
void MainWindow::setupSimpleDemo(QCustomPlot *customPlot)
{
    ...
    customPlot->axisRect()->setMinimumMargins(QMargins(left, top, right, bottom)); // add some more minimum space at bottom left of rect for subfigure label (15 is default)
